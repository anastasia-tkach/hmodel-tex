...
% 
\begin{draft}
In \VideoLimOcclusions{} we further investigate tracking failures that include long phases of total occlusion; note how in these scenarios the mean-pose regularizer described in \cite[Eq.6]{tagliasacchi2015robust} helps tracking recovery.
\end{draft}
...
\end{draft}
% REMOVED DURING REVISIONS
% it is important to note that this problem can be resolved by switching from CUDA to  \emph{compute shaders}~(OpenGL~4.3).
