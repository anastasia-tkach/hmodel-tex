...
Our correspondence search leverages the structure of \Eq{convsurf}, by decomposing the surface into several elementary convolution elements $\element$, where $e$ indexes the \todo{20} \AnastasiaComment{30} elements of our template; see \Video{00:00}. As illustrated in Figure~\ref{fig:corresp}, elements are classified into 
