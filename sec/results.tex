...
\begin{draft}
It is important to note our metrics are designed to evaluate fitting precision; the method of~\cite{sharp2015accurate} still achieves good tracking robustness on such sequence, but the lack of user calibration heavily biases this metric.
\end{draft}
