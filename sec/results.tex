...
% 
\AnastasiaComment{maybe say again that both E2D and E3D are essential to judge about the system performance, because they are two sides of the distance between two sets.
AT: didn't we talk about this already a number of times?}
