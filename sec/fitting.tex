...
Let us call $\parpose_n$ the \emph{pose} parameters optimally aligning the rest-pose template to the data frame $\depth_n$. Euler angles transformations 
