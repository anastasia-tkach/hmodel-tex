...
\MP{I propose to re-structure his section and shorten it: First explain how the template is build  from MVS scans, then how we can adapt it to a user only with RGBG data.}
