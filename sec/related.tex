...
\MP{Yes, I think we can skip this paragraph, we already mention some of it in the introduction.}
...
\AT{I testing them and I \emph{think} they are discriminative}

\paragraph{Generative Methods}
\TODO{differentiable renderer \cite{bogo2015detailed}}
\TODO{Oberwerger: synthesize a tracking model \cite{}}
\AT{Do we really need to go deep in describing the various generative models? If so, I would say the comparison can be done according to the type of model used... aka \Figure{handmodels}}
% Oikonomidis et. al. \cite{oikonomidis2014evolutionary}
% Schroder et. al. \cite{schroder2014real}
% Tompson et. al. \cite{tompson2014real}
% Sridhar et. al. \cite{sridhar2015fast}
% Sun et. al. \cite{sun2015cascaded}
% Sharp et. al. \cite{sharp2015accurate}


\MP{I think we do need to discuss them, otherwise it would make it too easy for reviewers to say that we missed relevant related work. But I agree that the comparison should focus on the model that is used.}
...
% 
The method in \cite{taylor2014user} shares a few similarities with our work, but with a fundamental difference in the way in which geometry is represented. \todo{As discussed next, our convolutional model is \emph{naturally compact}, leading to a straightforward calibration and tracking algorithms.}
