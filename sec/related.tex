...
\label{sec:related}
% place a camera directly on the user's wrist~\cite{kim2012digits}.

\brief{Instrumented + Multi-Camera}
...
\paragraph{Discriminative, generative and hybrid}
