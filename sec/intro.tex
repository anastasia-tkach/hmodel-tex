...
% 
Therefore, the main goal of this paper is to explore novel tracking templates that strike an optimal \emph{balance} between accuracy and performance, that is, a model that is able to more accurately capture the user's geometry, while retaining the ability to answer registration queries in close form with very high efficiency. In \Figure{coarsemodel} and \todo{Video [00:00]} we illustrate the importance of employing a tracking template striking this delicate balance.
...
\paragraph{Contributions \TODO{ANDREA}}

\begin{itemize}
\setlength\itemsep{-.5em}
\item Suggested a hand model representation well suited for user-specific adaption, tracking and animation 
\item Identified a good tracking template topology
...
\item Improved accuracy of state-of-art hand tracking system
\end{itemize}