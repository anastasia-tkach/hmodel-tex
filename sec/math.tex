...
\newcommand{\restcenters}{{\mathbf{C}}}
...
\newcommand{\realsense}{\emph{Intel\textcopyright RealSense}}
\newcommand{\kinectone}{\emph{Microsoft\textcopyright KinectOne}}
...
\newcommand{\citeme}{[Tkach et al. 2016]}
