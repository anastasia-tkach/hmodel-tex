...
% 
\todo{In our template, rigid components are shown in} {\color{darkgreen}dark green}, articulated parts in {\color{purple}purple} and elastic parts in {\color{lightgreen}light green}.
% 
